...
public class Server extends javax.swing.JFrame {
    ...
    static public class ServerSite extends Thread {
        ...
        public ServerSite(Socket ss) throws IOException {
            sock = ss;
        ...
        public void run() {
            try {
                ...
                while (true) {
                    ...
                    //if(s.equals(prv.toString())) continue;
...
//                StringBuilder everything = new StringBuilder();
                    ...
                    for (int i = 0; i < ConnectionArray.size(); i++) {
                        ...
                        ObjectOutputStream out = new ObjectOutputStream(temp_sock.getOutputStream());
